...
// this will give us getters setters, constructors..
@Data
// in order to tell that this class is going to be a collection, and to store documents inside the collection
@Document
public class Student {
    ...
    // it will now fail if we try to register two users with the same email
    @Indexed(unique = true)
